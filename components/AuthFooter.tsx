  ...
  return (
    <footer className="overflow-hidden border-top" style={{ background: "#f7f7f7", borderTopColor: "#e6e6e6" }}>
      <div className="container py-40 container-lg">
        <div className="auth-footer__grid">
          ...
          <div className="footer-item" style={{ minWidth: 0 }}>
            ...
            <div className="gap-12 mb-10 flex-align">
              ...
              <a href="tel:+884911975996" className="text-gray-900 text-md hover-text-main-600">+884 0911 975 996</a>
            </div>
            <div className="gap-12 mb-10 flex-align">
              <span className="flex-shrink-0 w-32 h-32 border border-gray-100 flex-center rounded-circle text-main-two-600 text-md">
                <i className="ph-fill ph-envelope"></i>
              </span>
              <a href="mailto:hotro@sieuthivina.com" className="text-gray-900 text-md hover-text-main-600">hotro@sieuthivina.com</a>
            </div>
            <div className="gap-12 mb-16 flex-align">
              <span className="flex-shrink-0 w-32 h-32 border border-gray-100 flex-center rounded-circle text-main-two-600 text-md">
                <i className="ph-fill ph-map-pin"></i>
              </span>
              <span className="text-gray-900 text-md">No.XXXX Fengshi.rd, Shigang - Taichung, Taiwan</span>
            </div>
          </div>
          ...
          <div className="footer-item" style={{ minWidth: 0 }}>
            ...
            <p className="text-gray-600 mb-14">Truy cập các nền tảng mạng xã hội của chúng tôi.</p>
            <ul className="gap-12 flex-align">
      ...
      <div style={{ background: "#ececec", borderTop: "1px solid #e2e2e2" }}>
        <div className="container flex-wrap gap-16 py-12 container-lg d-flex justify-content-center align-items-center" style={{ columnGap: 28 }}>
